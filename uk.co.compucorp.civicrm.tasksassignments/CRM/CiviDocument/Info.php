 ...
 *
 */
class CRM_CiviDocument_Info extends CRM_Core_Component_Info {
  ...
  public function getInfo() {
    return array(
      'name' => 'CiviDocument',
      'translatedName' => ts('CiviDocument'),
      'title' => ts('CiviCRM Document Engine'),
      'search' => 1,
  ...
  public function getUserDashboardElement() {
    /*return array('name' => ts('Documents'),
      'title' => ts('Your Document(s)'),
  ...
  public function registerTab() {
    return array('title' => ts('Documents'),
      'id' => 'document',
      'url' => 'document',
      'weight' => 99,
    );
