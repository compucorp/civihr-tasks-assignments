...
gulp.task('js-requirejs-bundle', function (done) {
...
gulp.task('watch', function () {
  ...
  ], ['js-requirejs-bundle']).on('change', function (file) {
...
gulp.task('default', ['js-crm', 'js-requirejs-bundle', 'sass', 'test', 'watch']);
